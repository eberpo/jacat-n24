...
def visualize_similar_images(cosine_similarities, images, reference_image_index, urls, n=5):
...
def main():
    ...
    return cosine_similarities, images_cpy, urls

#visualize_similar_images(cosine_similarities, images_cpy, index, urls, n=5)
